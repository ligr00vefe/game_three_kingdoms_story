...
export const CHARACTER_MODELS: Record<string, CharacterModelDef> = {
  ...
  guanwu_t2: {
    ...
    airDashEffectYOffset: 30,
    forwardThrustMotion: true,
    animations: { idle: 6, walk: 8, jump: 6, climb: 6, attack: 6, skill: 6 },
    assetAction: { skill: 'slash' },
  },
  zhaoyun_t2: {
    code: 'zhaoyun_t2', assetPrefix: 'zhaoyun_t2', fallbackTexture: 'guanwu_idle', frameSize: 192, groundLift: -10, visualScale: 1.22,
    airDashEffectYOffset: 30,
